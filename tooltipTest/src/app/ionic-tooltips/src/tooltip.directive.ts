...
console.log(this._componentFactoryResolver.resolveComponentFactory(TooltipBox))
console.log(<any>this.appRef.componentTypes)
console.log(this.appRef.componentTypes)
  ...
  private _createTooltipComponent() {
    console.log('Inside private _createTooltipComponent() ')
